...
import mobileTriggerCSS from './mobile-trigger.css';
import type {
  ResolvedConfig,
  MobileTriggerIcon,
...
// Styles are now loaded from mobile-trigger.css via raw import
...
export class MobileTrigger {
  ...
  init(): void {
    ...
    if (!this.stylesInjected) {
      injectStyles(document, mobileTriggerCSS, "pillar-mobile-trigger-styles");
